...
export default function AppContent() {
  ...
  const content = showEditor ? <PersistentInvoiceEditor onClose={() => setShowEditor(false)} /> : activeView === "Factures" ? <LocalInvoicesView /> : activeView === "Paiements" ? <LocalPaymentsView /> : activeView === "Clients" ? <LocalDirectoryView kind="customers" /> : activeView === "Produits" ? <LocalDirectoryView kind="products" /> : activeView === "Paramètres" ? <LocalSettingsView /> : activeView === "Rapports" ? <LocalReportsView /> : activeView === "Notifications" ? <LocalNotificationsView /> : activeView === "Aide" ? <LocalHelpView /> : activeView === "Offres" ? <LocalPlansView /> : <LocalDashboard onCreate={() => setShowEditor(true)} onNavigate={openView} onEdit={(invoice) => { void duplicateLocalInvoice(invoice).then(() => setShowEditor(true)); }} />;
